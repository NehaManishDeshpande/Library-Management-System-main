...
--inserting into issued for renew
insert into issued_books values(01,'The Alchemist',03,'Isha Kulkarni','9607010119',curdate()-3,curdate()+4);

--inserting into issued_books (Remminder)
insert into issued_books values(01,'The Alchemist',01,'Neha Deshpande','8767442778',curdate(),curdate()+3);
insert into issued_books values(02,'Harry Porter',01,'Neha Deshpande','8767442778',curdate(),curdate());
insert into issued_books values(04,'Wings Of Fire',01,'Neha Deshpande','8767442778',curdate(),curdate()-3);

--insertig into issued_books for fine
insert into issued_books values(02,'Harry Porter',02,'Niranjan Dangi','9322851793',curdate(),curdate()-1);
